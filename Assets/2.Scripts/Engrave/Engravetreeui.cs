...
public class EngraveTreeUI : MonoBehaviour
{
    ...
    private void InitializeTree()
    {
        ...
        {
            Debug.LogError("[EngraveTreeUI] EngraveManager �Ǵ� TreeData�� �����ϴ�.");
            return;
        }
    ...
    private void RefreshAll()
    {
        ...
        if (metaPointsText != null)
            metaPointsText.text = $"���� ����Ʈ: {manager.AvailableMetaPoints}";

        if (totalInvestedText != null)
            totalInvestedText.text = $"���� �Ϸ�: {manager.TotalInvestedPoints}";
    ...
    {
        if (metaPointsText != null)
            metaPointsText.text = $"���� ����Ʈ: {newAmount}";
    }
